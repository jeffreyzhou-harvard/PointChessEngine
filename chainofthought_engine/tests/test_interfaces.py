...
from chainofthought_engine.core.types import (
    square,
    square_file,
...
from chainofthought_engine.uci import UCIProtocol
from chainofthought_engine.uci.protocol import ENGINE_AUTHOR, ENGINE_NAME
from chainofthought_engine.ui import serve
...
class TestUIScaffold:
    def test_make_server_returns_uiserver(self):
        ...
        from chainofthought_engine.ui import make_server, UIServer
...
class TestLayering:
    ...
    def test_core_has_no_outward_imports(self):
        ...
        forbidden = ("chainofthought_engine.search", "chainofthought_engine.uci",
    ...
    def test_search_does_not_import_uci_or_ui(self):
        ...
        forbidden = ("chainofthought_engine.uci", "chainofthought_engine.ui")
