"""Sandbox tool dispatcher tests (no LLM required, mirrors debate's)."""
from __future__ import annotations

from pathlib import Path

from methodologies.ensemble.tools import make_dispatch
...
def test_write_then_read_then_list(tmp_path: Path):
    ...
    assert "core/board.py" in dispatch("list_files", {})
