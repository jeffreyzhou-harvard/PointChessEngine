...
from methodologies.langgraph.agents import run_role
from methodologies.langgraph.state import AgentLog, FileEntry, OrchestratorState
...
def _initial_state(
    ...
    output_dir: str | Path = "./engines/langgraph",
...
def build_graph(llm: BaseChatModel) -> Any:
    ...
    ``methodologies.langgraph.runner.run`` for the typical CLI flow with
